	...
	<div class="detail-preview" :style='{"width":"100%","padding":"10px 7% 20px","margin":"0px auto 0","position":"relative","background":"none"}'>
		<div class="attr" :style='{"border":"1px solid #ddd","minHeight":"620px","padding":"10px 0 0px 0px","boxShadow":"0px 0px 4px #eee","overflow":"hidden","flexWrap":"wrap","background":"rgba(255,255,255,1)","display":"flex","position":"relative","justifyContent":"space-between"}'>
			...
			<div class="info" :style='{"minHeight":"500px","width":"48%","padding":"10px 10px 10px 20px","margin":"0","background":"none"}'>
				...
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>景点类型</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.jingdianleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>景点等级</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.jingdiandengji}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>票价</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.piaojia}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>票数</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.piaoshu}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>服务电话</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.fuwudianhua}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#999","textAlign":"right","background":"linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5","width":"102px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>详细地址</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","background":"linear-gradient(270deg, rgba(255,255,255,1) 0%, rgba(230,245,229,1) 100%),#e6f5e5"}'>{{detail.xiangxidizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"0","margin":"0 0 15px 0","borderColor":"#c6ecc6","borderWidth":"0px 0px 1px","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
		...
		<el-tabs class="detail" :style='{"border":"4px solid #c7eec2","boxShadow":"0 0px 0px rgb(0 0 0 / 30%)","padding":"10px","margin":"20px 0 0","borderRadius":"2px","background":"rgba(255,255,255,1)"}' v-model="activeName" type="border-card">
			<el-tab-pane label="景点详情" name="first">
				<div v-html="detail.jingdianxiangqing"></div>
			</el-tab-pane>
