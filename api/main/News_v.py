...
# 注册接口
@main_bp.route("/python1s2c1/news/register", methods=['POST'])
def python1s2c1_news_register():
...
# 登录接口
@main_bp.route("/python1s2c1/news/login", methods=['GET','POST'])
def python1s2c1_news_login():
...
# 登出接口
@main_bp.route("/python1s2c1/news/logout", methods=['POST'])
def python1s2c1_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python1s2c1/news/resetPass", methods=['POST'])
def python1s2c1_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python1s2c1/news/session", methods=['GET'])
def python1s2c1_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python1s2c1/news/page", methods=['GET'])
def python1s2c1_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python1s2c1/news/autoSort", methods=['GET'])
def python1s2c1_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python1s2c1/news/list", methods=['GET'])
def python1s2c1_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python1s2c1/news/save", methods=['POST'])
def python1s2c1_news_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python1s2c1/news/add", methods=['POST'])
def python1s2c1_news_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python1s2c1/news/thumbsup/<id_>", methods=['GET'])
def python1s2c1_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python1s2c1/news/info/<id_>", methods=['GET'])
def python1s2c1_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python1s2c1/news/detail/<id_>", methods=['GET'])
def python1s2c1_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python1s2c1/news/update", methods=['POST'])
def python1s2c1_news_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python1s2c1/news/delete", methods=['POST'])
def python1s2c1_news_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python1s2c1/news/vote/<int:id_>", methods=['POST'])
def python1s2c1_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python1s2c1/news/group/<columnName>", methods=['GET'])
def python1s2c1_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python1s2c1/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python1s2c1_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python1s2c1/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python1s2c1_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 推荐算法接口
@main_bp.route("/python1s2c1/news/autoSort2", methods=['GET'])
def python1s2c1_news_autoSort2():
    if request.method == 'GET':

        leixing = set()
        req_dict = session.get("req_dict")
        userinfo = session.get("params")
        sql = "select inteltype from storeup where userid = "+userinfo.get("id")+" and tablename = 'news' order by addtime desc"
        try:
            data = db.session.execute(sql)
            rows = data.fetchall()
            for row in rows:
        ...
        L = []
        sql ="select * from news where $intelRecomColumn in ('%s"%("','").join(leixing)+"') union all select * from news where $intelRecomColumn not in('%s"%("','").join(leixing)+"')"
        data = db.session.execute(sql)
...
# 统计接口
@main_bp.route("/python1s2c1/news/remind/<columnName>/<type>", methods=['GET'])  #
def python1s2c1_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
