...
# 注册接口
@main_bp.route("/python1s2c1/storeup/register", methods=['POST'])
def python1s2c1_storeup_register():
...
# 登录接口
@main_bp.route("/python1s2c1/storeup/login", methods=['GET','POST'])
def python1s2c1_storeup_login():
...
# 登出接口
@main_bp.route("/python1s2c1/storeup/logout", methods=['POST'])
def python1s2c1_storeup_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python1s2c1/storeup/resetPass", methods=['POST'])
def python1s2c1_storeup_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python1s2c1/storeup/session", methods=['GET'])
def python1s2c1_storeup_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python1s2c1/storeup/page", methods=['GET'])
def python1s2c1_storeup_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python1s2c1/storeup/autoSort", methods=['GET'])
def python1s2c1_storeup_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python1s2c1/storeup/list", methods=['GET'])
def python1s2c1_storeup_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python1s2c1/storeup/save", methods=['POST'])
def python1s2c1_storeup_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python1s2c1/storeup/add", methods=['POST'])
def python1s2c1_storeup_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python1s2c1/storeup/thumbsup/<id_>", methods=['GET'])
def python1s2c1_storeup_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python1s2c1/storeup/info/<id_>", methods=['GET'])
def python1s2c1_storeup_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python1s2c1/storeup/detail/<id_>", methods=['GET'])
def python1s2c1_storeup_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python1s2c1/storeup/update", methods=['POST'])
def python1s2c1_storeup_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python1s2c1/storeup/delete", methods=['POST'])
def python1s2c1_storeup_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python1s2c1/storeup/vote/<int:id_>", methods=['POST'])
def python1s2c1_storeup_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python1s2c1/storeup/group/<columnName>", methods=['GET'])
def python1s2c1_storeup_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python1s2c1/storeup/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python1s2c1_storeup_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python1s2c1/storeup/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python1s2c1_storeup_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 推荐算法接口
@main_bp.route("/python1s2c1/storeup/autoSort2", methods=['GET'])
def python1s2c1_storeup_autoSort2():
    if request.method == 'GET':

        leixing = set()
        req_dict = session.get("req_dict")
        userinfo = session.get("params")
        sql = "select inteltype from storeup where userid = "+userinfo.get("id")+" and tablename = 'storeup' order by addtime desc"
        try:
            data = db.session.execute(sql)
            rows = data.fetchall()
            for row in rows:
        ...
        L = []
        sql ="select * from storeup where $intelRecomColumn in ('%s"%("','").join(leixing)+"') union all select * from storeup where $intelRecomColumn not in('%s"%("','").join(leixing)+"')"
        data = db.session.execute(sql)
...
# 统计接口
@main_bp.route("/python1s2c1/storeup/remind/<columnName>/<type>", methods=['GET'])  #
def python1s2c1_storeup_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
