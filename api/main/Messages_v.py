...
# 注册接口
@main_bp.route("/python1s2c1/messages/register", methods=['POST'])
def python1s2c1_messages_register():
...
# 登录接口
@main_bp.route("/python1s2c1/messages/login", methods=['GET','POST'])
def python1s2c1_messages_login():
    if request.method == 'GET' or request.method == 'POST':
        ...
        datas = messages.getbyparams(messages, messages, req_model)
        if not datas:
...
# 登出接口
@main_bp.route("/python1s2c1/messages/logout", methods=['POST'])
def python1s2c1_messages_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python1s2c1/messages/resetPass", methods=['POST'])
def python1s2c1_messages_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python1s2c1/messages/session", methods=['GET'])
def python1s2c1_messages_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python1s2c1/messages/page", methods=['GET'])
def python1s2c1_messages_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python1s2c1/messages/autoSort", methods=['GET'])
def python1s2c1_messages_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python1s2c1/messages/list", methods=['GET'])
def python1s2c1_messages_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python1s2c1/messages/save", methods=['POST'])
def python1s2c1_messages_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python1s2c1/messages/add", methods=['POST'])
def python1s2c1_messages_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python1s2c1/messages/thumbsup/<id_>", methods=['GET'])
def python1s2c1_messages_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python1s2c1/messages/info/<id_>", methods=['GET'])
def python1s2c1_messages_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python1s2c1/messages/detail/<id_>", methods=['GET'])
def python1s2c1_messages_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python1s2c1/messages/update", methods=['POST'])
def python1s2c1_messages_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python1s2c1/messages/delete", methods=['POST'])
def python1s2c1_messages_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python1s2c1/messages/vote/<int:id_>", methods=['POST'])
def python1s2c1_messages_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python1s2c1/messages/group/<columnName>", methods=['GET'])
def python1s2c1_messages_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        msg['data'] = messages.groupbycolumnname(messages,messages,columnName,req_dict)
        msg['data'] = msg['data'][:10]
        return jsonify(msg)

# 按值统计接口
@main_bp.route("/python1s2c1/messages/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python1s2c1_messages_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
    ...
    if request.method == 'GET':
        ...
        msg['data'] = messages.getvaluebyxycolumnname(messages,messages,xColumnName,yColumnName,req_dict)
        msg['data'] = msg['data'][:10]
        return jsonify(msg)

# 按日期统计接口
@main_bp.route("/python1s2c1/messages/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python1s2c1_messages_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 推荐算法接口
@main_bp.route("/python1s2c1/messages/autoSort2", methods=['GET'])
def python1s2c1_messages_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python1s2c1/messages/remind/<columnName>/<type>", methods=['GET'])  #
def python1s2c1_messages_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
        ...
        data = messages.getbetweenparams(
            messages,
            messages,
            columnName,
            {
